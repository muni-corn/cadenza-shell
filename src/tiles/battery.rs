...
impl BatteryWidget {
    pub fn new() -> Self {
        ...
        if service.available() {
            ...
            let update_display = glib::clone!(@weak icon_label, @weak service, @weak progress_bar, @weak percentage_label => move || {
                ...
                glib::timeout_add_local_once(std::time::Duration::from_secs(3),
                    glib::clone!(@weak icon_label, @weak progress_bar, @weak percentage_label => move || {
            ...
            service.connect_percentage_notify(glib::clone!(@strong update_display => move |_| {
                update_display();
            }));

            service.connect_charging_notify(glib::clone!(@strong update_display => move |_| {
                update_display();
            }));
